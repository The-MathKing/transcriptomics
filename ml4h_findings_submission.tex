...
\caption{Qualitative confidence distributions on real spatial data (Left: Lymph Node; Right: Cortex). The uncalibrated DestVI model produces highly uncalibrated predictions, which are effectively smoothed to biologically plausible profiles by Temperature Scaling.}
\label{fig:real_data}
\end{figure}
