...
\section{Results}
\label{sec:results}
Our results (Figure \ref{fig:rel}) show that DestVI has an In-Distribution Expected Calibration Error (ECE) of 0.233. This baseline indicates that out-of-the-box variational models exhibit some degree of miscalibration. 
