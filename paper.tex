...
\hypersetup{
    pdfauthor={Anonymous},
    pdftitle={Benchmarking Confidence Calibration in Spatial Transcriptomics Models Under Distribution Shift},
    pdfsubject={Submitted to ML4H 2026: Findings}
}
...
We utilize the public Mouse Cortex scRNA-seq dataset available via the \texttt{squidpy} python package (\url{https://squidpy.readthedocs.io}). All code to reproduce this pipeline and data preprocessing is available in our GitHub repository at \url{https://anonymous.4open.science/r/transcriptomics-AF35/}.
...
\label{tab:results}
\begin{tabular}{l r@{\,$\pm$\,}l c r@{\,$\pm$\,}l r@{\,$\pm$\,}l}
\toprule
Shift & \multicolumn{2}{c}{Uncalibrated} & $p$-value (vs.\ Base) & \multicolumn{2}{c}{Temperature Scaled} & \multicolumn{2}{c}{Isotonic Regression} \\
\midrule
0\% Dropout (1.0, baseline) & 0.215 & 0.019 & -- & 0.067 & 0.015 & 0.007 & 0.006 \\
20\% Dropout (0.8) & 0.220 & 0.020 & $3.88 \times 10^{-5}$ & 0.067 & 0.017 & 0.008 & 0.007 \\
40\% Dropout (0.6) & 0.228 & 0.018 & $2.63 \times 10^{-6}$ & 0.069 & 0.015 & 0.009 & 0.009 \\
60\% Dropout (0.4) & 0.238 & 0.018 & $3.16 \times 10^{-6}$ & 0.069 & 0.015 & 0.010 & 0.009 \\
80\% Dropout (0.2) & 0.259 & 0.017 & $9.18 \times 10^{-6}$ & 0.070 & 0.012 & 0.018 & 0.016 \\
\bottomrule
\end{tabular}
\end{table*}
